...
username = "riddhimann"
password = os.getenv('VYAS_PASSWORD_PREPROD')
...
def token(username, password):
    API = "https://doctors.preproduction.navyanetwork.com/alphaBackend/accounts/auth/token/"
    headers = {
...
def trigger_cache_update():
    url = 'https://doctors.preproduction.navyanetwork.com/cbsearch/api/cacheupdate/'
    headers = {
...
def check_status(task_id):
    url = 'https://doctors.preproduction.navyanetwork.com/cbsearch/api/cacheupdatestatus/'
    headers = {
        'sec-ch-ua-platform': '"Windows"',
        'Referer': 'https://alpha.bestopinions.us/cbsearchcacherefresh',
        'sec-ch-ua': '"Google Chrome";v="131", "Chromium";v="131", "Not_A Brand";v="24"',
